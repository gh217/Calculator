...
public class Calculator {
   ...
   static Scanner input = new Scanner(System.in);
    ...
    //to seperates opernand and operation
    public static String[] seperate(String str) throws Exception{
        String result="";
    ...
    public static Double operation(String[] arr) throws Exception{
    ...
    public static void process(Stack<Double> opd , Stack<Character> opt  ) throws Exception{
        char op=opt.pop();
        Double op1=opd.pop();
        /// to solve - 5 + 1    
